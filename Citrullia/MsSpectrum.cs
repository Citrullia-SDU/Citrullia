...
{
    /// <summary>
    /// The abstract class containing general information about <see cref="RawScan"/> and <see cref="XTSpectrum"/>.
    /// </summary>
    internal abstract class MsSpectrum
    {
        ...
        internal RawScan ParentScan { get; set; }
