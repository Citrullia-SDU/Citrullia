...
namespace Citrullia
{
    ...
    internal static class Quantification
    {
        ...
        internal static Dictionary<XTSpectrum, RawScan> argSpecScanDict = new Dictionary<XTSpectrum, RawScan>();
        ...
        internal static List<QuantResult> QuantificationResults = new List<QuantResult>();
        ...
        /// <returns>The new dictionary without the removed spectra.</returns>
        internal static Dictionary<XTSpectrum, RawScan> RemoveFromkvpArgSpecScanDict(XTSpectrum argSpec)
        {
        ...
        /// </summary>
        internal static void DoQuantification()
        {
            // Create a list of temporary list of quantification result
            List<QuantResult> resultsQuant = new List<QuantResult>();
        ...
        /// </summary>
        /// <param name="resultsQuant">The list of quantification results.</param>
        private static void ArginineQuantification(List<QuantResult> resultsQuant)
        {
            foreach (KeyValuePair<XTSpectrum, RawScan> kvp in argSpecScanDict)
            {
                // Create an empty instance of quantification result
                QuantResult result = new QuantResult();
        ...
        private static List<QuantResult> ReturnQuantResults(List<QuantResult> resultsQuant)
        {
