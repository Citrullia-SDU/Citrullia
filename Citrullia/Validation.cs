...
namespace Citrullia
{
    ...
    internal static class Validation
    {
        ...
        internal static List<ValResult> citValResults = new List<ValResult>();
        /// <summary>List of arginine spectra validation.</summary>
        internal static List<ValResult> argValResults = new List<ValResult>();
        /// <summary>List of lonely citrullination spectra validation.</summary>
        internal static List<ValResult> loneCitValResults = new List<ValResult>();
        ...
        private static List<ValResult> ReturnVResultCit(List<ValResult> vResultList)
        {
        ...
        private static List<ValResult> ReturnValResultArg(List<ValResult> vResultList)
        {
        ...
        private static List<int> GetListOfUsedIDs()
        {
            ...
            foreach (ValResult citResult in citValResults)
            {
        ...
        private static List<ValResult> ReturnValResultLoneCit(List<ValResult> vResultList)
        {
